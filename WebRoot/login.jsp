...
<%
	...
	if(action !=null && action.trim().equals("OK")) {
		...
		for(int i=0;i<users.size();i++) {
			User u = users.get(i);
			if(username.equals(u.getAccount()) && password.equals(u.getPassword()))  {
...
<div class="login">
	...
	<form method="post" action="login.jsp">
		...
		<button class="btn btn-primary btn-block btn-large" onclick="window.location.href='admin/UserReg.jsp'">注册</button>
